...
dataset['Logreturn_lag1']=dataset['Logreturn'].shift(1)
dataset['Sentiment_lag1']=dataset['Sentiment'].shift(1)
dataset['Direction_returns_lag1']=dataset['Direction_returns'].shift(1)
dataset['Direction_sentiment_lag1']=dataset['Direction_sentiment'].shift(1)
dataset['Direction_sentiment_lag2']=dataset['Direction_sentiment_lag1'].shift(1)
dataset=dataset.dropna()
dataset
dataset.iloc[:, [2,5,11,13,14]]

X = dataset.iloc[:, [5,13,14]].values

y = dataset.iloc[:, 4].values

print(f'The train dataset has {dataset.shape[0]} observations')
...
def plot_confusion_matrix(conf_matrix, classes, title, normalize = False, cmap = plt.cm.BuPu):
    """
